...
const CHINESE_LOCATION_INFO_MESSAGE_SECOND = '不要停下来，继续向前骑行';

const INFO_MESSAGE = IS_CHINESE ? CHINESE_INFO_MESSAGE : ENGLISH_INFO_MESSAGE;
const FULL_MARATHON_RUN_TITLE = IS_CHINESE ? '长距离骑行' : 'Long Ride';
const HALF_MARATHON_RUN_TITLE = IS_CHINESE ? '中距离骑行' : 'Medium Ride';
...
const NIGHT_RUN_TITLE = IS_CHINESE ? '夜间骑行' : 'Night Ride';
const RUN_GENERIC_TITLE = IS_CHINESE ? '骑行' : 'Ride';
const RUN_TRAIL_TITLE = IS_CHINESE ? '山地骑行' : 'Trail Ride';
const RUN_TREADMILL_TITLE = IS_CHINESE ? '室内骑行' : 'Indoor Ride';
